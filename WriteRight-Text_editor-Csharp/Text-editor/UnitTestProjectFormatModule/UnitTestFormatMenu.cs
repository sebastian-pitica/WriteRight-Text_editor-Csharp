...
namespace UnitTestProjectFormatModule
{
    ...
    public class UnitTestFormatModule
    {
        ...
        public void TestMethodColorForm()
        {
            ...
            var command = ThemeCommand.GetCommandObj();
        ...
        public void TestMethodSyntaxForm()
        {
            ...
            var command = SyntaxHighlightCommand.GetCommandObj();
        ...
        public void TestMethodFormatForm()
        {
            ...
            var command = FormatDocument.GetCommandObj();
            command.SetTarget(_mainTextBox);
            command.Execute();
            Assert.AreEqual(ExpectedResult, _mainTextBox.Text.ToString());
        }
    }
